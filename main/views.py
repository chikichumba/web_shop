...
class CatalogView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        category_slug = kwargs.get('category_xlug')
        ...
        for param,filter_func in self.FILTER_MAPPING.items():
            ...
            if value:
                ...
                filetr_params[param]= value
            else:
                filetr_params[param] = ''

        filetr_params['q'] = query or ''
    ...
    def get(self, request, *args, **kwargs):
        ...
        if request.headers.get('HX-Request'):
            ...
            elif context.get('resert_search'):
                return TemplateResponse(request, 'main/search_button.html', ())
            template = 'maim/filter_modal.html' if request.GET.get('show_filters') == 'true' else 'main/caralog.html'
...
class ProductDetailView(DetailView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        context = self.get_context_data(**kwargs)
        if request.headers.get('HX-Requests'):
